    ...
    return (
        <div className=' rounded-lg shadow-sm bg-white dark:bg-[#1D232A] dark:border hover:shadow-2xl hover:-translate-y-1 transition-all duration-300'>
         ...
         <div className='p-4 space-y-3'>
          <h2 className='text-2xl font-semibold text-[#1f1f1f] dark:text-white'>{propertyName}</h2>
          <p className='text-gray-500 text-[15px] leading-6 font-medium dark:text-gray-300'>
