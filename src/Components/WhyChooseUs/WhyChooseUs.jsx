    ...
    <div>
      <section className="w-11/12 mx-auto my-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 my-4 max-w-xl mx-auto text-[16px] font-medium dark:text-gray-400">
            We focus on trust, comfort, and transparency — making your property
            journey easier and smoother.
          </p>
        </div>
        <div className="grid gap-8 grid-cols-4">
          <div className="card bg-base-100 border    shadow-sm p-5 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="card bg-base-100 border shadow-sm p-5 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            <FaShieldAlt className="text-4xl text-[#FF5A3C] mb-4" />
              <h2 className="text-xl font-semibold mb-2 dark:text-gray-400">Secure & Transparent</h2>
              <p className="text-gray-600 text-[16px] dark:text-gray-400">
